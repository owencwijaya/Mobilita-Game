...
int main()
{
    ...
    printf("KAIN_PEMBUNGKUS_WAKTU == KAIN_PEMBUNGKUS_WAKTU ? %s\n", KAIN_PEMBUNGKUS_WAKTU == KAIN_PEMBUNGKUS_WAKTU ? "TRUE" : "FALSE");
    printf("KAIN_PEMBUNGKUS_WAKTU == SENTER_PEMBESAR ? %s\n", KAIN_PEMBUNGKUS_WAKTU == SENTER_PEMBESAR ? "TRUE" : "FALSE");
    printf("KAIN_PEMBUNGKUS_WAKTU == PINTU_KEMANA_SAJA ? %s\n", KAIN_PEMBUNGKUS_WAKTU == PINTU_KEMANA_SAJA ? "TRUE" : "FALSE");
    printf("KAIN_PEMBUNGKUS_WAKTU == MESIN_WAKTU ? %s\n", KAIN_PEMBUNGKUS_WAKTU == MESIN_WAKTU ? "TRUE" : "FALSE");
    printf("KAIN_PEMBUNGKUS_WAKTU == SENTER_PENGECIL ? %s\n", KAIN_PEMBUNGKUS_WAKTU == SENTER_PENGECIL ? "TRUE" : "FALSE");
    printf("KAIN_PEMBUNGKUS_WAKTU == NULL ? %s\n", KAIN_PEMBUNGKUS_WAKTU == NULL ? "TRUE" : "FALSE");
